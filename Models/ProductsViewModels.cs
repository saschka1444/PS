...
namespace SmartShop.Models
{
    ...
    public class SmartShopEntities : SmartShopContext
    {
...
OrderDetails { get; set; }
    ...
    public partial class ShoppingCart
    {
        ...
        public static ShoppingCart GetCart(Controller controller)
        {
           ...
           public void AddToCart(Smartphone smartphone)
        {
            // Get the matching cart and album instances
            var cartItem = storeDB.Carts.SingleOrDefault(
                c => c.CartId == ShoppingCartId 
                && c.SmartphoneId == smartphone.SmartphoneId);
           ...
           public decimal GetTotal()
           {
               ...
               decimal? total = (from cartItems in storeDB.Carts
                                 ...
                                 cartItems.Smartphone.Price).Sum();
            ...
            foreach (var item in cartItems)
            {
                var orderDetail = new OrderDetail
                {
                   SmartphoneId = item.SmartphoneId,
                    ...
                    UnitPrice = item.Smartphone.Price,
                    Quantity = item.Count
                };
                 // Set the order total of the shopping cart
                orderTotal += (item.Count * item.Smartphone.Price);
